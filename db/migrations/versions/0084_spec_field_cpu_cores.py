...
def upgrade() -> None:
    op.execute("ALTER TABLE product_specs ADD COLUMN IF NOT EXISTS cpu_cores INTEGER")
    op.execute("""
...
def downgrade() -> None:
    ...
    op.execute("DELETE FROM spec_field_defs WHERE field_key = 'cpu_cores'")
